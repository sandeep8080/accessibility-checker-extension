...
import type { MessageAction, AuditResult, MappedViolation, Severity } from '../types';
...
async function runAudit(): Promise<AuditResult> {
  try {
    ...
    throw new Error('Failed to analyze the page. Please ensure you are not on a browser internal page.');
  }
}
